...
execute as @s[scores={wasd.temp=4}] run function wasd.abilities:affects/__generated__/block/115
execute unless score @s wasd.timer matches 1.. run function wasd.lib:rng/1-25
scoreboard players add @s wasd.timer 1
execute if score @s wasd.timer >= @s wasd.rng run function wasd.abilities:affects/__generated__/block/116