execute as @s[tag=wasd.north] run summon minecraft:item ~ ~-0.7 ~-0.7 {Motion:[0.0,0.1,-0.15],Item:{id:"minecraft:item_frame",Count:1b,tag:{display:{Name:'{"text":"Redstone Crafter","italic":false}'},CustomModelData:6370005,EntityTag:{Item:{id:"minecraft:item_frame",Count:1b,tag:{CustomModelData:6370005}},Tags:["wasd.redstone_crafter"],Facing:1b,Invulnerable:1b,Invisible:1b,Fixed:1b}}}}
execute as @s[tag=wasd.south] run summon minecraft:item ~ ~-0.7 ~0.7 {Motion:[0.0,0.1,0.15],Item:{id:"minecraft:item_frame",Count:1b,tag:  {display:{Name:'{"text":"Redstone Crafter","italic":false}'},CustomModelData:6370005,EntityTag:{Item:{id:"minecraft:item_frame",Count:1b,tag:{CustomModelData:6370005}},Tags:["wasd.redstone_crafter"],Facing:1b,Invulnerable:1b,Invisible:1b,Fixed:1b}}}}
execute as @s[tag=wasd.east] run summon minecraft:item ~0.7 ~-0.7 ~ {Motion:[0.15,0.1,0.0],Item:{id:"minecraft:item_frame",Count:1b,tag:   {display:{Name:'{"text":"Redstone Crafter","italic":false}'},CustomModelData:6370005,EntityTag:{Item:{id:"minecraft:item_frame",Count:1b,tag:{CustomModelData:6370005}},Tags:["wasd.redstone_crafter"],Facing:1b,Invulnerable:1b,Invisible:1b,Fixed:1b}}}}
