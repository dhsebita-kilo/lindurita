...
execute as @e[tag=wasd.box_location,tag=wasd.damage] at @s store result block ~ ~ ~ Items[0].tag.Damage int 1 run scoreboard players operation @s wasd.temp += 14 wasd.constants
