...
execute at @e[tag=wasd.box_location] run data modify block ~ ~ ~ Items set from storage minecraft:wasd.inventory Inventory2
...
function wasd.lib:storage/inventory/parse_inventory2
...
function wasd.lib:storage/inventory/store_inventory2
